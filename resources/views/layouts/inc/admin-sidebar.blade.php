                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link {{Request::is('admin/add-categories')? 'active':''}}" href="{{ url('admin/add-categories')}}">Add new Categories</a>
                                    <a class="nav-link {{Request::is('admin/categories')? 'active':''}}" href="{{ url('admin/categories')}}">View Categories</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePosts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link {{Request::is('admin/add-post')? 'active':''}}" href="{{ url('admin/add-post')}}">Add New Post</a>
